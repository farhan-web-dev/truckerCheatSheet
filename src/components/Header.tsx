        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center justify-end gap-3 flex-wrap sm:flex-nowrap">
            ...
            <Link href="/dashboard/chat" className="relative">
              <MessageSquare className="text-white w-6 h-6 cursor-pointer" />
            ...
            {/* Profile Image / Avatar with Link to settings */}
            <Link href="/dashboard/admin-settings">
              {loginUser?.profileUrl ? (
                ...
                <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center font-semibold text-white cursor-pointer">
                  {loginUser?.name?.[0] || "A"}
                </div>
              )}
            </Link>
